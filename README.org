#                            -*- mode: org; -*-
#
#+TITLE:          blueCFD-Core README for port of OpenFOAM dev
#+AUTHOR:                     FSD blueCAPE Lda
#+DATE:                        5th July 2024
#+LINK:                    http://bluecfd.com/Core
#+OPTIONS: author:nil ^:{}
# Copyright (c) 2013-2024 blueCAPE Lda.
...
* About blueCFD-Core
  ...
  source projects, as unofficial ports for up-to-date 64 bit Windows 10 and 11.
  ...
  Building for 32 bit and/or running on Windows XP, 7 to 8.1 should be possible
...
* Disclaimers
  FS Dynamics Portugal is responsible for the development of the blueCFD®-Core project:
