...
#+OPTIONS: author:nil ^:{}
# Copyright (c) 2014-2026 OpenFOAM Foundation.
...
*** Scotch/PtScotch
    + https://gitlab.inria.fr/scotch/scotch/-/archive/v7.0.8/scotch-v7.0.12.tar.bz2
...
*** ParaView
    + https://www.paraview.org/files/v6.1/ParaView-v6.1.1.tar.gz
